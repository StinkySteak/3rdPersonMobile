...
//     version 1.4.4
//     from Assets/InputSystem/StarterAssetsPNewInput.inputactions
//
...
public partial class @StarterAssetsPNewInput : IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @StarterAssetsPNewInput()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""StarterAssetsPNewInput"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private @StarterAssetsPNewInput m_Wrapper;
        public PlayerActions(@StarterAssetsPNewInput wrapper) { m_Wrapper = wrapper; }
